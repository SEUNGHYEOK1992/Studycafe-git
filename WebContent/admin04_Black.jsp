	    ...
	    <div id="main">
	    	<div id="sidebar">
		    	<ul>
		    		...
		    		<li><a href="blackList" id="thisbar">블랙리스트</a></li>
		    ...
		    <div id="memberBlack">
		    	<table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        <c:forEach items="${b_list }" var="black">
                            <tr>
                                <td>${black.idx }</td>
                                <td><a href="detail?id=${black.id}">${black.id }</a></td>
                                <td>${black.repo_content }</td>
                            </tr>
                        </c:forEach>
                	</tbody>
		    	</table>
		    	<div class="text-center">
		    		<ul class="pagination">
		    			<li class="page-item">
		    				...
		    				<a id="prevPage" class="page-link" href="./blackList?page=${currPage-1}" aria-label="Previous">
		    			...
		    			<li class="page-item">
		    				<a id="nextPage" class="page-link" href="./blackList?page=${currPage+1}" aria-label="Next">
