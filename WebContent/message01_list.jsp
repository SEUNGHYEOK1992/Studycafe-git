    ...
    <div id="main">
        <div class="main_img">
            ...
            <div class="text-center">
		    		<ul class="pagination">
		    			<li class="page-item">
		    				<a class="page-link" href="./messageList?page=1"><span>처음</span></a>
		    				<a id="prevPage" class="page-link" href="./messageList?page=${currPage-1}" aria-label="Previous">
		    			...
		    			<li class="page-item">
		    				<a id="nextPage" class="page-link" href="./messageList?page=${currPage+1}" aria-label="Next">
		    					<span aria-hidden="true">&raquo;</span>
	                    		<span class="sr-only">Next</span>
		    				</a>
		    				<a class="page-link" href="./messageList?page=${endPage }"><span>끝</span></a>
		    			</li>
		    		</ul>
		    	</div>
        </div>
