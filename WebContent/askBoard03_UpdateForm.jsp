					...
					<tbody>
						<tr>
							<td style="text-align: center;">
								<span>
									<textarea name="content" id="content" cols="30" rows="10" style="margin: 0px; width: 500px; height: 300px; resize: none; margin-top: 20px; margin-bottom: 20px;">${bbs.content}</textarea>
								</span>
							</td>
						</tr>
					</tbody>
